    ...
    tools = [
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Double click at a specific position or at the current cursor position",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "x": {
                            "type": "number",
                            "description": "X coordinate to double click (optional)"
                        },
                        "y": {
                            "type": "number",
                            "description": "Y coordinate to double click (optional)"
                        }
                    }
                }
            }
        },
        {
            ...
            "function": {
                ...
                "description": "Right click at a specific position or at the current cursor position",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "x": {
                            "type": "number",
                            "description": "X coordinate to right click (optional)"
                        },
                        "y": {
                            "type": "number",
                            "description": "Y coordinate to right click (optional)"
                        }
                    }
                }
            }
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Get browser information including CDP URL and viewport size",
                "parameters": {
                    "type": "object",
                    "properties": {}
                }
...
def get_file_tools() -> List[Dict[str, Any]]:
    ...
    tools = [
        ...
        },
        {
            ...
            "function": {
                "name": "file_upload",
                "description": "Upload a file to the sandbox (for binary files like images, PDFs, etc.)",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "file": {
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "path": {
                            "type": "string",
                            "description": "Path to file in sandbox to download"
                        }
                    },
                    "required": ["path"]
                }
